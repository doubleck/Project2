...
Define function using Golden-Section method to find $x_l \lt x_m \lt x_r$ such that $f(x_l) \ge f(x_m)  and  f(x_r) \ge f(x_m)$
...
```{r}
line.search <- function(f, x, gradf, tol = 1e-9, a.max = 2^5) {
...
g <- function(a) return(f(x + a*gradf)) # if g(a) is constant return this
